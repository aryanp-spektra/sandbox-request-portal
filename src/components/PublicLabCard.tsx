...
import { Layers, RefreshCw, ArrowUpRight, Sparkles } from "lucide-react";
...
export function PublicLabCard({ lab, index = 0 }: { lab: Lab; index?: number }) {
    ...
    >
      ...
      >
        ...
        <div className="flex flex-1 flex-col p-5">
          ...
          <h3 className="mb-2.5 font-display text-[16.5px] font-bold leading-snug text-ink clamp-2 min-h-[44px]">
            {lab.title}
          </h3>
